...
do
	...
	echo -e "${YELLOW}===========================================================${NC}"
	echo -e "${CYAN}1  - Start SugarChain Blockchain Explorer2[Including installation process]${NC}"
	echo -e "${CYAN}2  - View the usage of blockchain explorer2 resources${NC}"
	echo -e "${CYAN}3  - Delete blockchain explorer2 PM2 application${NC}"
	echo -e "${CYAN}4  - Blockchain explorer2 startOrReload${NC}"
